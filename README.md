...
Note: The `--host-port=0.0.0.0:8081` argument is required when using Docker containers, as it allows the emulator to accept connections from Docker containers (not just localhost).
