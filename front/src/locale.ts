...
export const SAVED_LOCALE_KEY = "savedLocale";
...
export const resources = {
  [LOCALES.en]: {
    translation: {
      ...
      championships: {
        overline: "Regional Championships",
        title: "Six regions. One national stage.",
        subtitle:
          "Select a region to see its next championship and browse past champions and regional podiums by event.",
        legendAnnounced: "Championship announced",
        legendQuiet: "Not yet announced",
        org: "Speedcubing Canada",
        statusAnnounced: "{{year}} announced",
        statusPending: "{{year}} pending",
        statusHeld: "{{year}} held",
        statusNone: "No championship yet",
        nextChampionship: "Next championship",
        ...
        registrationTbd: "Registration date to be announced",
        register: "Register on the WCA",
        viewOnWca: "View on the WCA",
        pastChampions: "Past champions",
        edition: "Edition",
        event: "Event",
        loadingChampions: "Loading champions…",
        noChampionsTitle: "No champions recorded",
        noChampionsBody: "Champions for this edition are not available yet.",
      ...
      account: {
        ...
        provinceChangeLimited:
          "You can only change your province once per year. You'll be able to change it again on {{date}}.",
        dob: "Date of Birth",
        region: "Region",
        admin: "Admin Section",
    ...
    resources: {
      ...
      ChampionshipsAdmin: {
        name: "Championship |||| Championships",
        fields: {
          id: "Id",
  ...
  [LOCALES.fr]: {
    translation: {
      ...
      championships: {
        overline: "Championnats régionaux",
        title: "Six régions. Une scène nationale.",
        subtitle:
          "Sélectionnez une région pour voir son prochain championnat et parcourir les anciens champions et podiums régionaux par épreuve.",
        legendAnnounced: "Championnat annoncé",
        legendQuiet: "Pas encore annoncé",
        org: "Speedcubing Canada",
        statusAnnounced: "{{year}} annoncé",
        statusPending: "{{year}} à venir",
        statusHeld: "{{year}} tenu",
        statusNone: "Aucun championnat",
        nextChampionship: "Prochain championnat",
        notAnnounced: "Pas encore annoncé",
        notAnnouncedBody:
        ...
        registrationTbd: "Date d'inscription à annoncer",
        register: "S'inscrire sur la WCA",
        viewOnWca: "Voir sur la WCA",
        pastChampions: "Anciens champions",
        edition: "Édition",
        event: "Épreuve",
        loadingChampions: "Chargement des champions…",
        noChampionsTitle: "Aucun champion enregistré",
        noChampionsBody:
          "Les champions de cette édition ne sont pas encore disponibles.",
      ...
      account: {
        ...
        provinceChangeLimited:
          "Vous ne pouvez changer de province qu'une fois par an. Vous pourrez en changer à nouveau le {{date}}.",
    ...
    resources: {
      ...
      ChampionshipsAdmin: {
        name: "Championnat |||| Championnats",
        fields: {
          id: "Id",
          competition_name: "Compétition",
          competition_id: "Id de compétition WCA",
          year: "Année",
          type: "Type",
